                ...
                <div className="menu h-4/5 flex flex-col justify-evenly">
                    ...
                    <div className="flex justify-center">
                        <Link to="/main/contactbook" className="flex flex-col items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" width="50px" height="50px" viewBox="0 0 117.021 122.881" enableBackground="new 0 0 117.021 122.881">
